    ...
    <div className=" py-48">
      <div className="max-w-screen-xl mx-auto w-full px-6">
        ...
        <div className="grid md:grid-cols-3 pb-32">
          <div className="md:pt-0 md:pr-4 pt-4 col-span-2">
            <p className="text-base leading-5 text-neutral-500 pb-4 ">
            ...
            <p className="text-base leading-5 text-neutral-500  pb-4">
              As someone who loves solving problems, Web Development was a
              natural transition after COVID-19 ground the touring industry to a
              standstill. Not one to sit on my heels, I began to teach myself
              how to code through{" "}
              <a
            ...
            <p className="text-base leading-5 text-neutral-500  pb-4">
              I believe that the right solution isn’t always the easiest, and
              that obstacles exist to help us grow.
            </p>
          </div>
        ...
        <ul className="grid lg:grid-cols-3 md:grid-cols-2 gap-4 ">
          <li className="flex flex-col gap-4">
            <svg
              className="fill-white w-20 h-20 gradient-background p-2 rounded-xl"
            ...
            <p className="text-base  text-neutral-400  ">
              ...
              managed over 400 websites where I used tools like Google
              Lighthouse and Page Speed Insights to ensure clients continued to
              deliver a responsive experience as web standards change.
            </p>
          </li>
          <li className="flex flex-col gap-4">
            <svg
            ...
            <p className="text-base  text-neutral-400  ">
              ...
              Whether it was creating a photography guide to help owners make
              their listings look more professional, successfully integrating
              ESLint and Prettier into a three-year-old codebase, or using
              MongoDB’s aggregation pipelines to help our team make data-driven
              decisions, I was always proactively looking for ways to benefit
              the company.
            </p>
          </li>
          <li className="flex flex-col gap-4">
            ...
            <p className="text-base  text-neutral-400  ">
              ...
              to crowds of over 70,000 people at stadiums and arenas all over
              the world. I also had the opportunity to deliver seamless
              broadcast audio for clients like Apple and the NFL in a highly
